 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(F,V){var B=F.length;F.push(V);e:for(;0<B;){var Z=B-1>>>1,ae=F[Z];if(0<i(ae,V))F[Z]=V,F[B]=ae,B=Z;else break e}}function n(F){return F.length===0?null:F[0]}function r(F){if(F.length===0)return null;var V=F[0],B=F.pop();if(B!==V){F[0]=B;e:for(var Z=0,ae=F.length,xe=ae>>>1;Z<xe;){var pn=2*(Z+1)-1,mn=F[pn],gn=pn+1,yn=F[gn];if(0>i(mn,B))gn<ae&&0>i(yn,mn)?(F[Z]=yn,F[gn]=B,Z=gn):(F[Z]=mn,F[pn]=B,Z=pn);else if(gn<ae&&0>i(yn,B))F[Z]=yn,F[gn]=B,Z=gn;else break e}}return V}function i(F,V){var B=F.sortIndex-V.sortIndex;return B!==0?B:F.id-V.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,l=o.now();t.unstable_now=function(){return o.now()-l}}var u=[],h=[],p=1,m=null,v=3,S=!1,A=!1,N=!1,D=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,w=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(F){for(var V=n(h);V!==null;){if(V.callback===null)r(h);else if(V.startTime<=F)r(h),V.sortIndex=V.expirationTime,e(u,V);else break;V=n(h)}}function C(F){if(N=!1,x(F),!A)if(n(u)!==null)A=!0,Jt(j);else{var V=n(h);V!==null&&ot(C,V.startTime-F)}}function j(F,V){A=!1,N&&(N=!1,I(y),y=-1),S=!0;var B=v;try{for(x(V),m=n(u);m!==null&&(!(m.expirationTime>V)||F&&!R());){var Z=m.callback;if(typeof Z=="function"){m.callback=null,v=m.priorityLevel;var ae=Z(m.expirationTime<=V);V=t.unstable_now(),typeof ae=="function"?m.callback=ae:m===n(u)&&r(u),x(V)}else r(u);m=n(u)}if(m!==null)var xe=!0;else{var pn=n(h);pn!==null&&ot(C,pn.startTime-V),xe=!1}return xe}finally{m=null,v=B,S=!1}}var M=!1,_=null,y=-1,E=5,T=-1;function R(){return!(t.unstable_now()-T<E)}function P(){if(_!==null){var F=t.unstable_now();T=F;var V=!0;try{V=_(!0,F)}finally{V?k():(M=!1,_=null)}}else M=!1}var k;if(typeof w=="function")k=function(){w(P)};else if(typeof MessageChannel<"u"){var Ge=new MessageChannel,zt=Ge.port2;Ge.port1.onmessage=P,k=function(){zt.postMessage(null)}}else k=function(){D(P,0)};function Jt(F){_=F,M||(M=!0,k())}function ot(F,V){y=D(function(){F(t.unstable_now())},V)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(F){F.callback=null},t.unstable_continueExecution=function(){A||S||(A=!0,Jt(j))},t.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<F?Math.floor(1e3/F):5},t.unstable_getCurrentPriorityLevel=function(){return v},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(F){switch(v){case 1:case 2:case 3:var V=3;break;default:V=v}var B=v;v=V;try{return F()}finally{v=B}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(F,V){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var B=v;v=F;try{return V()}finally{v=B}},t.unstable_scheduleCallback=function(F,V,B){var Z=t.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?Z+B:Z):B=Z,F){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=B+ae,F={id:p++,callback:V,priorityLevel:F,startTime:B,expirationTime:ae,sortIndex:-1},B>Z?(F.sortIndex=B,e(h,F),n(u)===null&&F===n(h)&&(N?(I(y),y=-1):N=!0,ot(C,B-Z))):(F.sortIndex=ae,e(u,F),A||S||(A=!0,Jt(j))),F},t.unstable_shouldYield=R,t.unstable_wrapCallback=function(F){var V=v;return function(){var B=v;v=V;try{return F.apply(this,arguments)}finally{v=B}}}})(Ay);Ry.exports=Ay;var nT=Ry.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function d1(t){return(await It(t,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}async function f1(t,e){return It(t,"GET","/v2/recaptchaConfig",mt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function k1(t,e={}){return It(t,"GET","/v2/passwordPolicy",mt(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function z1(t,e){return Er(t,"POST","/v1/accounts:signInWithPassword",mt(t,e))}async function c_(t,e){return It(t,"POST","/v1/accounts:sendOobCode",mt(t,e))}async function B1(t,e){return c_(t,e)}async function $1(t,e){return c_(t,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function W1(t,e){return Er(t,"POST","/v1/accounts:signInWithEmailLink",mt(t,e))}async function H1(t,e){return Er(t,"POST","/v1/accounts:signInWithEmailLink",mt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ci(t,e){return Er(t,"POST","/v1/accounts:signInWithIdp",mt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function G1(t,e){return It(t,"POST","/v1/accounts:sendVerificationCode",mt(t,e))}async function K1(t,e){return Er(t,"POST","/v1/accounts:signInWithPhoneNumber",mt(t,e))}async function Q1(t,e){const n=await Er(t,"POST","/v1/accounts:signInWithPhoneNumber",mt(t,e));if(n.temporaryProof)throw Cs(t,"account-exists-with-different-credential",n);return n}const Y1={USER_NOT_FOUND:"user-not-found"};async function X1(t,e){const n=Object.assign(Object.assign({},e),{operation:"REAUTH"});return Er(t,"POST","/v1/accounts:signInWithPhoneNumber",mt(t,n),Y1)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eS(t,e){return Er(t,"POST","/v1/accounts:signUp",mt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dS(t,e){return It(t,"POST","/v2/accounts/mfaEnrollment:start",mt(t,e))}const Al="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AS(t,e){return It(t,"POST","/v2/accounts/mfaSignIn:start",mt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new ts(this.firestore,e,this._query)}}class dt{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new hr(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new dt(this.firestore,e,this._key)}}class hr extends ts{constructor(e,n,r){super(e,n,uf(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new dt(this.firestore,null,new K(e))}withConverter(e){return new hr(this.firestore,e,this._path)}}function xP(t,e,...n){if(t=Ee(t),Fw("collection","path",e),t instanceof vu){const r=pe.fromString(e,...n);return iy(r),new hr(t,null,r)}{if(!(t instanceof dt||t instanceof hr))throw new q(L.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(pe.fromString(e,...n));return iy(r),new hr(t.firestore,null,r)}}function Qa(t,e,...n){if(t=Ee(t),arguments.length===1&&(e=V_.newId()),Fw("doc","path",e),t instanceof vu){const r=pe.fromString(e,...n);return ry(r),new dt(t,null,new K(r))}{if(!(t instanceof dt||t instanceof hr))throw new q(L.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(pe.fromString(e,...n));return ry(r),new dt(t.firestore,t instanceof hr?t.converter:null,new K(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
