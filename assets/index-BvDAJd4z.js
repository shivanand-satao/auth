 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ck=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),rt=(t,e)=>{const n=X.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:s=2,absoluteStrokeWidth:o,className:l="",children:u,...h},f)=>X.createElement("svg",{ref:f,...uk,width:i,height:i,stroke:r,strokeWidth:o?Number(s)*24/Number(i):s,className:["lucide",`lucide-${ck(t)}`,l].join(" "),...h},[...e.map(([p,y])=>X.createElement(p,y)),...Array.isArray(u)?u:[u]]));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ba(t,e,n){return`firebase:${t}:${e}:${n}`}class xi{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Ba(this.userKey,i.apiKey,s),this.fullPersistenceKey=Ba("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Sn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new xi(An(ug),e,r);const i=(await Promise.all(n.map(async h=>{if(await h._isAvailable())return h}))).filter(h=>h);let s=i[0]||An(ug);const o=Ba(r,e.config.apiKey,e.name);let l=null;for(const h of n)try{const f=await h._get(o);if(f){const p=Sn._fromJSON(e,f);h!==s&&(l=p),s=h;break}}catch{}const u=i.filter(h=>h._shouldAllowMigration);return!s._shouldAllowMigration||!u.length?new xi(s,e,r):(s=u[0],l&&await s._set(o,l.toJSON()),await Promise.all(n.map(async h=>{if(h!==s)try{await h._remove(o)}catch{}})),new xi(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function QS(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function YS(t){const e=xs(Ps(t)).link,n=e?xs(Ps(e)).deep_link_id:null,r=xs(Ps(t)).deep_link_id;return(r?xs(Ps(r)).link:null)||r||n||e||t}class Xd{constructor(e){var n,r,i,s,o,l;const u=xs(Ps(e)),h=(n=u.apiKey)!==null&&n!==void 0?n:null,f=(r=u.oobCode)!==null&&r!==void 0?r:null,p=QS((i=u.mode)!==null&&i!==void 0?i:null);B(h&&f&&p,"argument-error"),this.apiKey=h,this.operation=p,this.code=f,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(o=u.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(l=u.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const n=YS(e);try{return new Xd(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TR="__/auth/handler",IR="emulator/auth/handler",kR=encodeURIComponent("fac");async function Tg(t,e,n,r,i,s){B(t.config.authDomain,t,"auth-domain-config-required"),B(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:Jr,eventId:i};if(e instanceof Jd){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Bk(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,p]of Object.entries({}))o[f]=p}if(e instanceof Co){const f=e.getScopes().filter(p=>p!=="");f.length>0&&(o.scopes=f.join(","))}t.tenantId&&(o.tid=t.tenantId);const l=o;for(const f of Object.keys(l))l[f]===void 0&&delete l[f];const u=await t._getAppCheckToken(),h=u?`#${kR}=${encodeURIComponent(u)}`:"";return`${SR(t)}?${Qi(l).slice(1)}${h}`}function SR({config:t}){return t.emulator?Gd(t,IR):`https://${t.authDomain}/${TR}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Ur,C0;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,m){function _(){}_.prototype=m.prototype,T.D=m.prototype,T.prototype=new _,T.prototype.constructor=T,T.C=function(w,R,P){for(var k=Array(arguments.length-2),Pt=2;Pt<arguments.length;Pt++)k[Pt-2]=arguments[Pt];return m.prototype[R].apply(w,k)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(T,m,_){_||(_=0);var w=Array(16);if(typeof m=="string")for(var R=0;16>R;++R)w[R]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(R=0;16>R;++R)w[R]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=T.g[0],_=T.g[1],R=T.g[2];var P=T.g[3],k=m+(P^_&(R^P))+w[0]+3614090360&4294967295;m=_+(k<<7&4294967295|k>>>25),k=P+(R^m&(_^R))+w[1]+3905402710&4294967295,P=m+(k<<12&4294967295|k>>>20),k=R+(_^P&(m^_))+w[2]+606105819&4294967295,R=P+(k<<17&4294967295|k>>>15),k=_+(m^R&(P^m))+w[3]+3250441966&4294967295,_=R+(k<<22&4294967295|k>>>10),k=m+(P^_&(R^P))+w[4]+4118548399&4294967295,m=_+(k<<7&4294967295|k>>>25),k=P+(R^m&(_^R))+w[5]+1200080426&4294967295,P=m+(k<<12&4294967295|k>>>20),k=R+(_^P&(m^_))+w[6]+2821735955&4294967295,R=P+(k<<17&4294967295|k>>>15),k=_+(m^R&(P^m))+w[7]+4249261313&4294967295,_=R+(k<<22&4294967295|k>>>10),k=m+(P^_&(R^P))+w[8]+1770035416&4294967295,m=_+(k<<7&4294967295|k>>>25),k=P+(R^m&(_^R))+w[9]+2336552879&4294967295,P=m+(k<<12&4294967295|k>>>20),k=R+(_^P&(m^_))+w[10]+4294925233&4294967295,R=P+(k<<17&4294967295|k>>>15),k=_+(m^R&(P^m))+w[11]+2304563134&4294967295,_=R+(k<<22&4294967295|k>>>10),k=m+(P^_&(R^P))+w[12]+1804603682&4294967295,m=_+(k<<7&4294967295|k>>>25),k=P+(R^m&(_^R))+w[13]+4254626195&4294967295,P=m+(k<<12&4294967295|k>>>20),k=R+(_^P&(m^_))+w[14]+2792965006&4294967295,R=P+(k<<17&4294967295|k>>>15),k=_+(m^R&(P^m))+w[15]+1236535329&4294967295,_=R+(k<<22&4294967295|k>>>10),k=m+(R^P&(_^R))+w[1]+4129170786&4294967295,m=_+(k<<5&4294967295|k>>>27),k=P+(_^R&(m^_))+w[6]+3225465664&4294967295,P=m+(k<<9&4294967295|k>>>23),k=R+(m^_&(P^m))+w[11]+643717713&4294967295,R=P+(k<<14&4294967295|k>>>18),k=_+(P^m&(R^P))+w[0]+3921069994&4294967295,_=R+(k<<20&4294967295|k>>>12),k=m+(R^P&(_^R))+w[5]+3593408605&4294967295,m=_+(k<<5&4294967295|k>>>27),k=P+(_^R&(m^_))+w[10]+38016083&4294967295,P=m+(k<<9&4294967295|k>>>23),k=R+(m^_&(P^m))+w[15]+3634488961&4294967295,R=P+(k<<14&4294967295|k>>>18),k=_+(P^m&(R^P))+w[4]+3889429448&4294967295,_=R+(k<<20&4294967295|k>>>12),k=m+(R^P&(_^R))+w[9]+568446438&4294967295,m=_+(k<<5&4294967295|k>>>27),k=P+(_^R&(m^_))+w[14]+3275163606&4294967295,P=m+(k<<9&4294967295|k>>>23),k=R+(m^_&(P^m))+w[3]+4107603335&4294967295,R=P+(k<<14&4294967295|k>>>18),k=_+(P^m&(R^P))+w[8]+1163531501&4294967295,_=R+(k<<20&4294967295|k>>>12),k=m+(R^P&(_^R))+w[13]+2850285829&4294967295,m=_+(k<<5&4294967295|k>>>27),k=P+(_^R&(m^_))+w[2]+4243563512&4294967295,P=m+(k<<9&4294967295|k>>>23),k=R+(m^_&(P^m))+w[7]+1735328473&4294967295,R=P+(k<<14&4294967295|k>>>18),k=_+(P^m&(R^P))+w[12]+2368359562&4294967295,_=R+(k<<20&4294967295|k>>>12),k=m+(_^R^P)+w[5]+4294588738&4294967295,m=_+(k<<4&4294967295|k>>>28),k=P+(m^_^R)+w[8]+2272392833&4294967295,P=m+(k<<11&4294967295|k>>>21),k=R+(P^m^_)+w[11]+1839030562&4294967295,R=P+(k<<16&4294967295|k>>>16),k=_+(R^P^m)+w[14]+4259657740&4294967295,_=R+(k<<23&4294967295|k>>>9),k=m+(_^R^P)+w[1]+2763975236&4294967295,m=_+(k<<4&4294967295|k>>>28),k=P+(m^_^R)+w[4]+1272893353&4294967295,P=m+(k<<11&4294967295|k>>>21),k=R+(P^m^_)+w[7]+4139469664&4294967295,R=P+(k<<16&4294967295|k>>>16),k=_+(R^P^m)+w[10]+3200236656&4294967295,_=R+(k<<23&4294967295|k>>>9),k=m+(_^R^P)+w[13]+681279174&4294967295,m=_+(k<<4&4294967295|k>>>28),k=P+(m^_^R)+w[0]+3936430074&4294967295,P=m+(k<<11&4294967295|k>>>21),k=R+(P^m^_)+w[3]+3572445317&4294967295,R=P+(k<<16&4294967295|k>>>16),k=_+(R^P^m)+w[6]+76029189&4294967295,_=R+(k<<23&4294967295|k>>>9),k=m+(_^R^P)+w[9]+3654602809&4294967295,m=_+(k<<4&4294967295|k>>>28),k=P+(m^_^R)+w[12]+3873151461&4294967295,P=m+(k<<11&4294967295|k>>>21),k=R+(P^m^_)+w[15]+530742520&4294967295,R=P+(k<<16&4294967295|k>>>16),k=_+(R^P^m)+w[2]+3299628645&4294967295,_=R+(k<<23&4294967295|k>>>9),k=m+(R^(_|~P))+w[0]+4096336452&4294967295,m=_+(k<<6&4294967295|k>>>26),k=P+(_^(m|~R))+w[7]+1126891415&4294967295,P=m+(k<<10&4294967295|k>>>22),k=R+(m^(P|~_))+w[14]+2878612391&4294967295,R=P+(k<<15&4294967295|k>>>17),k=_+(P^(R|~m))+w[5]+4237533241&4294967295,_=R+(k<<21&4294967295|k>>>11),k=m+(R^(_|~P))+w[12]+1700485571&4294967295,m=_+(k<<6&4294967295|k>>>26),k=P+(_^(m|~R))+w[3]+2399980690&4294967295,P=m+(k<<10&4294967295|k>>>22),k=R+(m^(P|~_))+w[10]+4293915773&4294967295,R=P+(k<<15&4294967295|k>>>17),k=_+(P^(R|~m))+w[1]+2240044497&4294967295,_=R+(k<<21&4294967295|k>>>11),k=m+(R^(_|~P))+w[8]+1873313359&4294967295,m=_+(k<<6&4294967295|k>>>26),k=P+(_^(m|~R))+w[15]+4264355552&4294967295,P=m+(k<<10&4294967295|k>>>22),k=R+(m^(P|~_))+w[6]+2734768916&4294967295,R=P+(k<<15&4294967295|k>>>17),k=_+(P^(R|~m))+w[13]+1309151649&4294967295,_=R+(k<<21&4294967295|k>>>11),k=m+(R^(_|~P))+w[4]+4149444226&4294967295,m=_+(k<<6&4294967295|k>>>26),k=P+(_^(m|~R))+w[11]+3174756917&4294967295,P=m+(k<<10&4294967295|k>>>22),k=R+(m^(P|~_))+w[2]+718787259&4294967295,R=P+(k<<15&4294967295|k>>>17),k=_+(P^(R|~m))+w[9]+3951481745&4294967295,T.g[0]=T.g[0]+m&4294967295,T.g[1]=T.g[1]+(R+(k<<21&4294967295|k>>>11))&4294967295,T.g[2]=T.g[2]+R&4294967295,T.g[3]=T.g[3]+P&4294967295}r.prototype.u=function(T,m){m===void 0&&(m=T.length);for(var _=m-this.blockSize,w=this.B,R=this.h,P=0;P<m;){if(R==0)for(;P<=_;)i(this,T,P),P+=this.blockSize;if(typeof T=="string"){for(;P<m;)if(w[R++]=T.charCodeAt(P++),R==this.blockSize){i(this,w),R=0;break}}else for(;P<m;)if(w[R++]=T[P++],R==this.blockSize){i(this,w),R=0;break}}this.h=R,this.o+=m},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var m=1;m<T.length-8;++m)T[m]=0;var _=8*this.o;for(m=T.length-8;m<T.length;++m)T[m]=_&255,_/=256;for(this.u(T),T=Array(16),m=_=0;4>m;++m)for(var w=0;32>w;w+=8)T[_++]=this.g[m]>>>w&255;return T};function s(T,m){var _=l;return Object.prototype.hasOwnProperty.call(_,T)?_[T]:_[T]=m(T)}function o(T,m){this.h=m;for(var _=[],w=!0,R=T.length-1;0<=R;R--){var P=T[R]|0;w&&P==m||(_[R]=P,w=!1)}this.g=_}var l={};function u(T){return-128<=T&&128>T?s(T,function(m){return new o([m|0],0>m?-1:0)}):new o([T|0],0>T?-1:0)}function h(T){if(isNaN(T)||!isFinite(T))return p;if(0>T)return b(h(-T));for(var m=[],_=1,w=0;T>=_;w++)m[w]=T/_|0,_*=4294967296;return new o(m,0)}function f(T,m){if(T.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(T.charAt(0)=="-")return b(f(T.substring(1),m));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var _=h(Math.pow(m,8)),w=p,R=0;R<T.length;R+=8){var P=Math.min(8,T.length-R),k=parseInt(T.substring(R,R+P),m);8>P?(P=h(Math.pow(m,P)),w=w.j(P).add(h(k))):(w=w.j(_),w=w.add(h(k)))}return w}var p=u(0),y=u(1),A=u(16777216);t=o.prototype,t.m=function(){if(N(this))return-b(this).m();for(var T=0,m=1,_=0;_<this.g.length;_++){var w=this.i(_);T+=(0<=w?w:4294967296+w)*m,m*=4294967296}return T},t.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(x(this))return"0";if(N(this))return"-"+b(this).toString(T);for(var m=h(Math.pow(T,6)),_=this,w="";;){var R=D(_,m).g;_=I(_,R.j(m));var P=((0<_.g.length?_.g[0]:_.h)>>>0).toString(T);if(_=R,x(_))return P+w;for(;6>P.length;)P="0"+P;w=P+w}},t.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function x(T){if(T.h!=0)return!1;for(var m=0;m<T.g.length;m++)if(T.g[m]!=0)return!1;return!0}function N(T){return T.h==-1}t.l=function(T){return T=I(this,T),N(T)?-1:x(T)?0:1};function b(T){for(var m=T.g.length,_=[],w=0;w<m;w++)_[w]=~T.g[w];return new o(_,~T.h).add(y)}t.abs=function(){return N(this)?b(this):this},t.add=function(T){for(var m=Math.max(this.g.length,T.g.length),_=[],w=0,R=0;R<=m;R++){var P=w+(this.i(R)&65535)+(T.i(R)&65535),k=(P>>>16)+(this.i(R)>>>16)+(T.i(R)>>>16);w=k>>>16,P&=65535,k&=65535,_[R]=k<<16|P}return new o(_,_[_.length-1]&-2147483648?-1:0)};function I(T,m){return T.add(b(m))}t.j=function(T){if(x(this)||x(T))return p;if(N(this))return N(T)?b(this).j(b(T)):b(b(this).j(T));if(N(T))return b(this.j(b(T)));if(0>this.l(A)&&0>T.l(A))return h(this.m()*T.m());for(var m=this.g.length+T.g.length,_=[],w=0;w<2*m;w++)_[w]=0;for(w=0;w<this.g.length;w++)for(var R=0;R<T.g.length;R++){var P=this.i(w)>>>16,k=this.i(w)&65535,Pt=T.i(R)>>>16,Er=T.i(R)&65535;_[2*w+2*R]+=k*Er,E(_,2*w+2*R),_[2*w+2*R+1]+=P*Er,E(_,2*w+2*R+1),_[2*w+2*R+1]+=k*Pt,E(_,2*w+2*R+1),_[2*w+2*R+2]+=P*Pt,E(_,2*w+2*R+2)}for(w=0;w<m;w++)_[w]=_[2*w+1]<<16|_[2*w];for(w=m;w<2*m;w++)_[w]=0;return new o(_,0)};function E(T,m){for(;(T[m]&65535)!=T[m];)T[m+1]+=T[m]>>>16,T[m]&=65535,m++}function S(T,m){this.g=T,this.h=m}function D(T,m){if(x(m))throw Error("division by zero");if(x(T))return new S(p,p);if(N(T))return m=D(b(T),m),new S(b(m.g),b(m.h));if(N(m))return m=D(T,b(m)),new S(b(m.g),m.h);if(30<T.g.length){if(N(T)||N(m))throw Error("slowDivide_ only works with positive integers.");for(var _=y,w=m;0>=w.l(T);)_=F(_),w=F(w);var R=U(_,1),P=U(w,1);for(w=U(w,2),_=U(_,2);!x(w);){var k=P.add(w);0>=k.l(T)&&(R=R.add(_),P=k),w=U(w,1),_=U(_,1)}return m=I(T,R.j(m)),new S(R,m)}for(R=p;0<=T.l(m);){for(_=Math.max(1,Math.floor(T.m()/m.m())),w=Math.ceil(Math.log(_)/Math.LN2),w=48>=w?1:Math.pow(2,w-48),P=h(_),k=P.j(m);N(k)||0<k.l(T);)_-=w,P=h(_),k=P.j(m);x(P)&&(P=y),R=R.add(P),T=I(T,k)}return new S(R,T)}t.A=function(T){return D(this,T).h},t.and=function(T){for(var m=Math.max(this.g.length,T.g.length),_=[],w=0;w<m;w++)_[w]=this.i(w)&T.i(w);return new o(_,this.h&T.h)},t.or=function(T){for(var m=Math.max(this.g.length,T.g.length),_=[],w=0;w<m;w++)_[w]=this.i(w)|T.i(w);return new o(_,this.h|T.h)},t.xor=function(T){for(var m=Math.max(this.g.length,T.g.length),_=[],w=0;w<m;w++)_[w]=this.i(w)^T.i(w);return new o(_,this.h^T.h)};function F(T){for(var m=T.g.length+1,_=[],w=0;w<m;w++)_[w]=T.i(w)<<1|T.i(w-1)>>>31;return new o(_,T.h)}function U(T,m){var _=m>>5;m%=32;for(var w=T.g.length-_,R=[],P=0;P<w;P++)R[P]=0<m?T.i(P+_)>>>m|T.i(P+_+1)<<32-m:T.i(P+_);return new o(R,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,C0=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,Ur=o}).apply(typeof Ag<"u"?Ag:typeof self<"u"?self:typeof window<"u"?window:{});var ka=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mf{constructor(){this.Tr=new $e(Ve.Er),this.dr=new $e(Ve.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,n){const r=new Ve(e,n);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,n){e.forEach(r=>this.addReference(r,n))}removeReference(e,n){this.Vr(new Ve(e,n))}mr(e,n){e.forEach(r=>this.removeReference(r,n))}gr(e){const n=new q(new fe([])),r=new Ve(n,e),i=new Ve(n,e+1),s=[];return this.dr.forEachInRange([r,i],o=>{this.Vr(o),s.push(o.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const n=new q(new fe([])),r=new Ve(n,e),i=new Ve(n,e+1);let s=ee();return this.dr.forEachInRange([r,i],o=>{s=s.add(o.key)}),s}containsKey(e){const n=new Ve(e,0),r=this.Tr.firstAfterOrEqual(n);return r!==null&&e.isEqual(r.key)}}class Ve{constructor(e,n){this.key=e,this.wr=n}static Er(e,n){return q.comparator(e.key,n.key)||se(e.wr,n.wr)}static Ar(e,n){return se(e.wr,n.wr)||q.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=Ht.makeFromUrl(e,n)}catch{return new Ht(e,"")}if(r.path==="")return r;throw JC(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(D){D.path.charAt(D.path.length-1)==="/"&&(D.path_=D.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+i+o,"i"),u={bucket:1,path:3};function h(D){D.path_=decodeURIComponent(D.path)}const f="v[A-Za-z0-9_]+",p=n.replace(/[.]/g,"\\."),y="(/([^?#]*).*)?$",A=new RegExp(`^https?://${p}/${f}/b/${i}/o${y}`,"i"),x={bucket:1,path:3},N=n===tE?"(?:storage.googleapis.com|storage.cloud.google.com)":n,b="([^?#]*)",I=new RegExp(`^https?://${N}/${i}/${b}`,"i"),S=[{regex:l,indices:u,postModify:s},{regex:A,indices:x,postModify:h},{regex:I,indices:{bucket:1,path:2},postModify:h}];for(let D=0;D<S.length;D++){const F=S[D],U=F.regex.exec(e);if(U){const T=U[F.indices.bucket];let m=U[F.indices.path];m||(m=""),r=new Ht(T,m),F.postModify(r);break}}if(r==null)throw XC(e);return r}}class e2{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function t2(t,e,n){let r=1,i=null,s=null,o=!1,l=0;function u(){return l===2}let h=!1;function f(...b){h||(h=!0,e.apply(null,b))}function p(b){i=setTimeout(()=>{i=null,t(A,u())},b)}function y(){s&&clearTimeout(s)}function A(b,...I){if(h){y();return}if(b){y(),f.call(null,b,...I);return}if(u()||o){y(),f.call(null,b,...I);return}r<64&&(r*=2);let S;l===1?(l=2,S=0):S=(r+Math.random())*1e3,p(S)}let x=!1;function N(b){x||(x=!0,y(),!h&&(i!==null?(b||(l=2),clearTimeout(i),p(0)):b||(l=1)))}return p(0),s=setTimeout(()=>{o=!0,N(!0)},n),N}function n2(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
